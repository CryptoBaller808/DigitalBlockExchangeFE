  ...
  const r = class {
    constructor(e) {
      ...
      'Dark' === this._options.theme &&
        ...
        this._options.debug &&
          (o || ((o = true), console.log('Using CL v22.032 (internal id e2a841ff @ 2022-07-06T11:53:07.702Z)'))),
        this._create();
    }
    onChartReady(e) {
    ...
    _create() {
      ...
      (this._options.autosize || this._options.fullscreen) &&
        ...
        (this._innerWindowLoaded = new Promise((e) => {
          const t = () => {
            n.removeEventListener('load', t, false), e();
          };
          n.addEventListener('load', t, false);
        })),
        this._innerWindowLoaded.then(() => {
