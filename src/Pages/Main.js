...
const Main = ({ mintHandler }) => {
  ...
  const api_getcatogories = async () => {
    ...
    // ])
    // res.data.map((item) => {
    //   if(item.category_name == "Art"){
    //     categories.push({ lbl: "Art", ico: "./images/NFT Art 1.svg" })
    //   }
    // })
  };
        ...
        <div className="our-app flex flex-col">
          <div className="wrapWidth wrap flex flex-col">
            <div className="pg-hdr">
              Download the Digital Block Exchange app to explore NFTs
            </div>
            <div className="meta flex aic jc">
              ...
              <div className="right flex">
                <div className="meta flex  flex-col">
                  <div className="desc">
                    Digital Block Exchange website & app provides you with
                    simple & fast trading options!
                  </div>
                  <div className="apps-link flex aic jc flex-col">
                    ...
                    <div className="btn button flex aic">
                      <div className="logo flex aic jc">
                        <img
                          src="./images/google_store_logo.svg"
                          className="logo-img"
                        />
                      </div>
                      <div className="txt flex flex-col">
