          ...
          <div className="content-block flex">
            ...
            <div className="center flex flex-col w-full">
              ...
              <div className="graph-sec flex flex-col w-full">
                {/* <div className="graph-status mb-6 flex item-center justify-end">
                  <div className="status-g flex items-center justify-center">K Line</div>
                  <div className="status-y ml-4 flex items-center justify-center">Depth</div>
                </div> */}
