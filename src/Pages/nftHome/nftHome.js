              ...
              <Col>
                <div>
                  <h1 className="discover">
                    Discover, collect, and<br></br> sell extraordinary<br></br> NFTs
                  </h1>
                </div>
                <div>
                  <p className="dolar">
                    Dolor sit amet, consectetur adipiscing elit.<br></br> Faucibus ac ut turpis amet eleifend viverra.{" "}
                  </p>
                </div>
                <br></br>
            ...
            <Row className="rows">
              <Col style={{ marginBottom: "2rem" }}>
                ...
                <Card
                  ...
                  hoverable
                  style={{ width: 300 }}
                  cover={<img style={{ borderRadius: "1rem" }} alt="example" src="image 140.png" alt="" />}>
                  <div className="div1">
                    <div>
              ...
              <Col style={{ marginBottom: "2rem" }}>
                ...
                <Card
                  ...
                  hoverable
                  style={{ width: 260 }}
                  cover={<img style={{ borderRadius: "1rem" }} alt="example" src="image 158.png" alt="" />}>
                  <div className="div1">
                    <div>
                      <p>#37 The Boozer</p>
                    </div>
              ...
              <Col style={{ marginBottom: "2rem" }}>
                ...
                <Card
                  ...
                  hoverable
                  style={{ width: 260 }}
                  cover={<img style={{ borderRadius: "1rem" }} alt="example" src="image 138.png" alt="" />}>
                  <div className="div1">
                    <div>
                      <p>Pep Troopers.</p>
                    </div>
                  ...
                  <div className="div1">
                    <div>
                      <img className="group2123" src="Group 2123.png" alt=""></img>
                    </div>
                    <div className="bld">
              ...
              <Col style={{ marginBottom: "2rem" }}>
                ...
                <Card
                  ...
                  hoverable
                  style={{ width: 260 }}
                  cover={<img style={{ borderRadius: "1rem" }} alt="example" src="image 139.png" alt="" />}>
                  <div className="div1">
                    <div>
                      <p>ON1 #7467</p>
                    </div>
            ...
            <Row className="rows">
              <Col style={{ marginTop: "2rem", marginBottom: "2rem" }}>
                ...
                <Card
                  ...
                  hoverable
                  style={{ width: 300 }}
                  cover={<img style={{ borderRadius: "1rem" }} alt="example" src="image 156.png" alt="" />}>
                  <div className="div1">
                    <div>
              ...
              <Col style={{ marginTop: "2rem", marginBottom: "2rem" }}>
                ...
                <Card
                  ...
                  hoverable
                  style={{ width: 260 }}
                  cover={<img style={{ borderRadius: "1rem" }} alt="example" src="image 134.png" alt="" />}>
                  <div className="div1">
                    <div>
                      <p>HXH #0010</p>
                      <p style={{ fontWeight: "100" }}>Highest bid 1/1</p>
              ...
              <Col style={{ marginTop: "2rem", marginBottom: "2rem" }}>
                ...
                <Card
                  ...
                  hoverable
                  style={{ width: 260 }}
                  cover={<img style={{ borderRadius: "1rem" }} alt="example" src="image 157.png" alt="" />}>
                  <div className="div1">
                    <div>
              ...
              <Col style={{ marginTop: "2rem", marginBottom: "2rem" }}>
                ...
                <Card
                  ...
                  hoverable
                  style={{ width: 260 }}
                  cover={<img style={{ borderRadius: "1rem" }} alt="example" src="image 136.png" alt="" />}>
                  <div className="div1">
                    <div>
                      <p>POKErn #0020</p>
                      <p style={{ fontWeight: "100" }}>Highest bid 1/1</p>
            ...
            <Row className="rows">
              <Col style={{ marginTop: "2rem", marginBottom: "2rem" }}>
                ...
                <Card
                  ...
                  hoverable
                  style={{ width: 300 }}
                  cover={<img style={{ borderRadius: "1rem" }} alt="example" src="Mask Group.png" alt="" />}>
                  <div className="div1">
                    <div>
              ...
              <Col style={{ marginTop: "2rem", marginBottom: "2rem" }}>
                ...
                <Card
                  ...
                  hoverable
                  style={{ width: 260 }}
                  cover={<img style={{ borderRadius: "1rem" }} alt="example" src="image 142.png" alt="" />}>
                  <div className="div1">
                    <div>
              ...
              <Col style={{ marginTop: "2rem", marginBottom: "2rem" }}>
                ...
                <Card
                  ...
                  hoverable
                  style={{ width: 260 }}
                  cover={<img style={{ borderRadius: "1rem" }} alt="example" src="image 143.png" alt="" />}>
                  <div className="div1">
                    <div>
                      <p>Soccer Doge #8455.</p>
                    </div>
              ...
              <Col style={{ marginTop: "2rem", marginBottom: "2rem" }}>
                ...
                <Card
                  ...
                  hoverable
                  style={{ width: 260 }}
                  cover={<img style={{ borderRadius: "1rem" }} alt="example" src="image 144.png" alt="" />}>
                  <div className="div1">
                    <div>
                      <p>Soccer Doge #8455</p>
                    </div>
            ...
            <Row className="rows">
              <Col style={{ marginTop: "2rem", marginBottom: "2rem" }}>
                ...
                <Card
                  ...
                  hoverable
                  style={{ width: 300 }}
                  cover={<img style={{ borderRadius: "1rem" }} alt="example" src="image 145.png" />}>
                  <div className="div1">
                    <div>
                      <p>CloneX #14217</p>
                    </div>
              ...
              <Col style={{ marginTop: "2rem", marginBottom: "2rem" }}>
                ...
                <Card
                  ...
                  hoverable
                  style={{ width: 260 }}
                  cover={<img style={{ borderRadius: "1rem" }} alt="example" src="image 146.png" alt="" />}>
                  <div className="div1">
                    <div>
                      <p>Super Yeti #5588</p>
                    </div>
              ...
              <Col style={{ marginTop: "2rem", marginBottom: "2rem" }}>
                ...
                <Card
                  ...
                  hoverable
                  style={{ width: 260 }}
                  cover={<img style={{ borderRadius: "1rem" }} alt="example" src="image 147.png" alt="" />}>
                  <div className="div1">
                    <div>
                      <p>Holy Cow #170</p>
                    </div>
              ...
              <Col style={{ marginTop: "2rem", marginBottom: "2rem" }}>
                ...
                <Card
                  ...
                  hoverable
                  style={{ width: 260 }}
                  cover={<img style={{ borderRadius: "1rem" }} alt="example" src="image 148.png" alt="" />}>
                  <div className="div1">
                    <div>
                      <p>Crumby #479</p>
                    </div>
