        ...
        <div className='swapTransModal'>
            <Card className='swapModal-card shadow-lg py-3'>
                <Card.Body>
                    ...
                    <p className='mb-2 text-center'>Swapping <span className='fw-bold'>{fixedSwapFrom} {swapFromCurrency}</span> for <span className='fw-bold'>{fixedSwapTo} {swapToCurrency}</span></p>
