...
const PlaceBid = ({ open, setOpen, selecteditem }) => {
  ...
  return (
    <div className="place-bid flex flex-col">
      <div
        className="ico flex aic  pointer justify-end"
      ...
      <div className="wrap flex flex-col">
        <div className="hdr flex flex-col">
          ...
          <div className="btn-bid flex aic jc">
            <div 
            onClick={bidOnNFT}
            className="btn button">{loading ? "Waiting to accept.." : "Place a Bid"}</div>
          </div>
        </div>
      </div>
    </div>
