  ...
  return (
        ...
        <img src={item?.item_detail?.image_uri} className="img" />
            ...
            <div className="nft-rating flex">
                ...
                <div 
                className="r-like flex aic">
                  {
                   hightlightstar
                    ?
                      <div 
                      onClick={() => removewishlist(item?.item_detail?.id)}
                      className="ico">
                      <HeartFillIcon />
                      </div>
                    :
                      <div 
                      onClick={() => addtoWishlist(item?.item_detail?.id)}
                      className="ico">
                      <HeartIcon />
                      </div>
            ...
            }
            {
              item?.sale_type == 2
              &&
              <div onClick={(e) => setOpen2(true)} className="btn button cleanbtn">Place a bid</div>
            }
            </div>
        </div>
        </div>
