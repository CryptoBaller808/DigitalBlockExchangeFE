  ...
  return (
    ...
    <div className="nft-detail flex flex-col">
        ...
        <div className="container flex">
            ...
            <div className="detail-box flex flex-col">
              ...
              <div className="blk flex flex-col">
                <div className="item flex aic">
                  ...
                  <div className="ri">
                    <p className="lbl">View on XRPL Explorer</p>
                  </div>
                </div>
                <div className="item flex aic">
                  <div className="le flex aic">
                  ...
                  <div className="ri">
                    <p className="lbl">
                      {data?.current_owner_details?.firstname}
                      <br />  {data?.current_owner_details?.email}
                    </p>
                  </div>
                </div>
                <div className="item flex aic">
          ...
          <div className="right flex flex-col">
            <div className="exploded-box flex flex-col">
              <div className="hdr-tag">Exploded</div>
              <div className="num">{data?.title}</div>
              {
                data?.item_sale_info && 
                <div className="sale-tag flex aic">
                  <div className="s-lbl">On sale for </div>{" "}
                  <span className="s-tag">{data?.item_sale_info?.price} XRP</span>
                </div>
              }
              ...
              <div className="collector-sec">
                <div className="item flex flex-col">
                  ...
                  <div className="nft-img flex aic">
                    ...
                    <div className="nft-name">{data.creator?.firstname} {data.creator?.lastname}</div>
                  </div>
                </div>
                <div className="item flex flex-col">
            ...
            <div className="history-box flex flex-col">
              ...
              <div className="blk flex flex-col">
                {data?.item_activity?.map((item) => 
                    ...
                    <div className="ri">
                      <p className="lbl">
                        Transferred  {moment(new Date(item?.entry_date))?.fromNow()}
                        <br />
                        to
      ...
      <Modal open={open} onClose={() => setOpen(false)}>
        <Completecheckout open={open} setOpen={setOpen} id={id} iteminfo={{...selecteditem,...selecteditem?.item_sale_info}}/>
      </Modal>
      <Modal open={open2} onClose={() => setOpen2(false)}>
        <PlaceBid open={open2} setOpen={setOpen2} selecteditem={{...selecteditem,...selecteditem?.item_sale_info}}/>
      </Modal>
    </div>
  );
};
