...
exports.getIBCompatibleTimeframe = getIBCompatibleTimeframe;
exports.currencies = exports.configurationData = exports.dev = void 0;
var dev = true; // True to enable logs inside the console
...
function makeApiRequest(path) {
  var response;
  return regeneratorRuntime.async(function makeApiRequest$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return regeneratorRuntime.awrap(fetch("https://min-api.cryptocompare.com/".concat(path)));
...
function getIBCompatibleTimeframe(timeframe) {
  var timeframes = {
    "1S": "1 secs",
    "5S": "5 secs",
    "10S": "10 secs",
